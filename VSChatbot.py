...
def response(key):
    ...
    conversations = {'welcome' :"Hi, I'm JJ, a chatbot. \nMy job is to help people with information about "
                    ...
                    'drug addiction' : "It sounds that you are suffering from drug addiction"
                                        "you should therefore seek medical assistance from trusted clinicians.\n"
                                        "Some of them are as listed below \n\n"
                                        "1. Foundation of Hope Treatment center \n"
                                        "2. NACADA \n"
                                        "3. KNH \n\n",
                     ...
                     'Category B': "Based on your answers you should be entitled to: \n"
                                   "1. A Category B recognition payment of sh. 10,000 \n"
                     ...
                     'Category C': "Based on your answers you should be entitled to: \n"
                                   "1. A Category C recognition payment of sh. 5,000 \n"
                                   "2. 10 free counselling sessions \n"
                                   "3. Financial assistance for lost wages if you needed time off work, or if any of"
                                   " your property was damaged or stolen during the attack \n\n",

                     'Category D': "Based on you answers you should be entitled to: \n"
                                   "1. A Category D recognition payment of sh. 1,500 \n"
                                   "2. 10 free counselling sessions \n"
                     ...
                     'counselling': "Two options for free counselling include: \n"
                                    ...
                                    "2. Apply to Victims Services for Kenyan government-funded counselling with "
                     ...
                     'free legal services': "Here's some information on free legal services: \n\n"
                                            ...
                                            "Phone:  254722509760 \n"
                                            "Location: Amboseli Rd, Off Gitanga Rd \n"
                                            "Email:  info@fidakenya.org \n"
                                            "National Legal Aid Awareness Programme: \n"
                                            "Location:  9th Floor, KCS House, Opposite International House, Mama Ngina St, Nairobi"
                                            "Phone: +44 7988 819187 \n\n"
                                            "ALN: \n"
                                            "Phone: 1800 639 784 \n\n"
                     ...
                     'sexual abuse information': "Here's a link to some information on your legal rights: \n"
                                                 "http://wezeshadada.com/wp-content/uploads/2014/12/Kenya-Gender-based-and-sexual-violence.pdf/ \n\n" ,

                     'AVO': "Here's some information from the Southern Women's Group about how to make an Apprehended "
                            "Violence Order work for you: https://help.unhcr.org/kenya/helpful-services/sexual-gender-based-violence/\n\n",
...
def stateManager(user_response, state):
    ...
    drug = ["addict", "addiction", "drug", "drugs"]
